...
//	@GetMapping("/")
//	public String index() {
//		System.out.println("인덱스 페이지로 오는지 확인");
//		
//		return "index.html";
//	} //
	...
	public String postListPage(Model model) { //Model 사용을 위해 선언
		...
		System.out.println(postList.get(0).getMbrNickName());
...
//	@RequestMapping(value = "/postDetailPage/{postNumber}" , method = RequestMethod.GET )
//	public String postDetailPage(
//			@PathVariable("postNumber") Long postNumber, //PathVariable : 클릭 시 해당 p_no값을 받아 오기 위한 annotation
//			Model model
//			) { 
//		// PathVariable 을 통해 p_no 받아온다
//		// 해당 p_no의 글 정보 가져온다
//		PostDetailDto postDetail = postService.getPostDetail(postNumber);
//
//		System.out.println("@@@@@@@@@@@@@@@@@ p_no값 넘어 오는지 컨트롤러 테스트 : "+postNumber);
//		
...
//		// 값들고오는지 확인
//		System.out.println(postRegisterDto.getPostTitle());
//		System.out.println(postRegisterDto.getPostContent());
