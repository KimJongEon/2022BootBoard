...
public class LogInService implements UserDetailsService{
	...
	@Override
	public UserDetails loadUserByUsername(String mbr_id) throws UsernameNotFoundException { // mbr_id 사용
	    Optional<MemberEntity> memberEntityWrapper = memberRepository.findByMbrId(mbr_id);
